...
public class LevelManager : MonoBehaviour
{
    ...
    [SerializeField] private Text _doubleSpeedInfo;
    ...
    private void Update ()
    {
        ...
        // Double game speed
        if(_doubleSpeed){
            _doubleSpeedInfo.text = "2x Speed";
            _doubleSpeedInfo.color = Color.yellow;
            Time.timeScale = 2;
        }
        else{
            _doubleSpeedInfo.text = "1x Speed";
            _doubleSpeedInfo.color = Color.black;
            Time.timeScale = 1;
        }
